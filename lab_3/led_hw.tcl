...
add_interface_port avalon_slave iWrite_n write_n Input 1
add_interface_port avalon_slave iLed writedata Input 32
...
add_interface_port conduit_end oLed export Output 32
